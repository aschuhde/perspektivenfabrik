...
export interface ApplicationModelsApiModelsApiProjectTag extends ApplicationModelsApiModelsApiBaseEntityWithId { 
    tagName?: string;
    tagNameTranslations?: Array<ApplicationApiDataTypesApiTranslationValue>;
}
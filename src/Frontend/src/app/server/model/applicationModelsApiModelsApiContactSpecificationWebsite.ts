...
export interface ApplicationModelsApiModelsApiContactSpecificationWebsite extends ApplicationModelsApiModelsApiContactSpecification { 
    website?: DomainDataTypesUrl;
}
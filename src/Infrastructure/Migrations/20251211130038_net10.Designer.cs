...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251211130038_net10")]
    partial class net10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Infrastructure.Data.DbEntities.DbProjectImage", b =>
                {
                    ...
                    b.OwnsOne("Infrastructure.Data.DbDataTypes.DbGraphicsContent", "Thumbnail", b1 =>
                        {
                            b1.Property<Guid>("DbProjectImageEntityId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Infrastructure.Data.DbDataTypes.DbPostalAddress", "PostalAddress", b1 =>
                        {
                            ...
                            b1.ToTable("LocationSpecifications", t =>
                                {
                                    t.Property("AddressDisplayName")
                                        .HasColumnName("DbPostalAddress_PostalAddress_AddressDisplayName");

                                    t.Property("AddressText")
                                        .HasColumnName("DbPostalAddress_PostalAddress_AddressText");
                                });
